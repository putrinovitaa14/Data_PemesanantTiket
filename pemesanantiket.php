...
<body>
    <fieldset>
        <center>
            <img src="../gambar/assalaam.png" width="250" height="200">
            <h2>Selamat Datang</h2>
            <h2>Pemesanan Tiket Destinasi Wisata di Yogyakarta</h2>
        </center>
        <div class="container">
    ...
    <table align="center">
        <tr>
            <td>
                <h3>>Anda Memasuki Wisata Bukit Bintang</h3< /td>
        </tr>
        <tr>
...
<?php
    ...
    <table align="center">
        <tr>
            <td>
                <h3>>Anda Memasuki Wisata Pantai Sandrana</h3< /td>
        </tr>
        <tr>
            <td>Pemesan atas nama</td>
            <td>:</td>
...
<?php
    ...
    <table align="center">
        <tr>
            <td>
                <h3>>Anda Memasuki Wisata Candi Borobudur/Prambanan</h3< /td>
        </tr>
        <tr>
            <td>Pemesan atas nama</td>
            <td>:</td>
...
<?php
    ...
    <table align="center">
        <tr>
            <td>
                <h3>>Anda Memasuki Wisata Malioboro/Keraton</h3< /td>
        </tr>
        <tr>
            <td>Pemesan atas nama</td>
            <td>:</td>
...
<?php
    ...
    <table align="center">
        <tr>
            <td>
                <h3>>Anda Memasuki Wisata Goa Pindul</h3< /td>
        </tr>
        <tr>
            <td>Pemesan atas nama</td>
            <td>:</td>
...
<?php
    ...
    <table align="center">
        <tr>
            <td>
                <h3>>Anda Memasuk Kawasan Cafe</h3< /td>
        </tr>
        <tr>
            <td>Pemesan atas nama</td>
            <td>:</td>
